...
from neroRL.nn.encoder import CNNEncoder, ResCNN, LinVecEncoder, AttentionEncoder
...
class ActorCriticBase(Module):
    ...
    def create_base_model(self, config, vis_obs_space, vec_obs_shape):
        ...
        """
        vis_encoder, vec_encoder, recurrent_layer, transformer_layer, body = None, None, None, None, None
        ...
        return vis_encoder, vec_encoder, recurrent_layer, transformer_layer, body
    ...
    def create_vis_encoder(self, config, vis_obs_space):
        ...
        elif config["vis_encoder"] == "attention_encoder":
            return AttentionEncoder(vis_obs_space, config, self.activ_fn)
